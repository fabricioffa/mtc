        ...
        <div class="container mw-100 pb-5 mb-5 px-0">
            ...
            <div class="d-flex flex-column flex-xl-row justify-content-end font-space-grotesk pt-lg-5 mt-4 mt-xl-5">
                <div
                    ...
                    <h1 class="fw-bold ls-1 fs-36-64 mb-3 mt-5 mt-xxl-0">{{__('Sms Marketing desde')}} <span
                            class="text-secondary">0.019€</span></h1>
                    <p class="fs-18-22 pb-5 mb-0 mb-lg-3">{{__('Com uma taxa de leitura de 99,9%, e com custos de entrega desde 1,9 CENT. por mensagem o SMS Marketing é de longe e sem duvida o mais eficiente canal de que dispõe para veicular a sua comunicação.')}}</p>
    ...
    <section class="bg-primary font-space-grotesk pb-5 pt-4">
        <div class="container pb-5 pb-lg-6">
            ...
            <header class="col-lg-7 col-xxl-6 text-center mx-auto pb-4">
                <h2 class="text-white fw-bold fs-30-36 mb-3">{{__('Envie SMS’s em Massa ao melhor preço do mercado')}}</h2>
                <p class="col-10 col-xl-9 fw-light fs-18-20 text-d3d2 mx-auto">{{__('Enviar SMS nas suas campanhas de Marketing nunca foi tão simples e descomplicado')}}</p>
            </header>
            ...
            <div class="row justify-content-center gap-4 pt-4 pt-lg-5 mt-lg-2">
                <div class="col-11 col-md-7 col-lg-5 col-xxl bg-1d1e1f rounded-20 p-4">
                    ...
                    <div class="ps-2">
                        <h3 class="text-ef fw-500 fs-22">{{__('Importe os seus contactos')}}</h3>
                        <p class="fs-16-18 text-d3d2 fw-light">{{__('Pode gerir os seus contactos de forma rápida e eficiente. Importe-os atravêz dos nossos formatos CVS ou TXT, e tenha os seus contactos prontos em segundos.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-11 col-md-7 col-lg-5 col-xxl bg-1d1e1f rounded-20 p-4 mt-3 mt-lg-0">
                    ...
                    <div class="ps-2">
                        <h3 class="text-ef fw-500 fs-22">{{__('Escreva a sua mensagem')}}</h3>
                        <p class="fs-16-18 text-d3d2 fw-light">{{__('Escreva a mensagem que deseja enviar, personalizando diferentes campos e até mesmo o seus contactos.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-11 col-md-7 col-lg-5 col-xxl bg-1d1e1f rounded-20 p-4 mt-3 mt-lg-0">
                    ...
                    <div class="ps-2 pe-1">
                        <h3 class="text-ef fw-500 fs-22">{{__('Enviar')}}</h3>
                        <p class="fs-16-18 text-d3d2 fw-light">{{__('Envie a sua mensagem personalizada, onde posteriormente poderá aceder aos nossos serviços para ver todas as estatisticas da sua campanha de marketing')}}</p>
                    </div>
                </div>
            </div>
    ...
    <section class="home bg-fa font-space-grotesk pt-lg-5">
        <div class="container pt-3 mt-2 pt-lg-0 mt-lg-0">
            <header class="text-center pb-4 pt-5">
                <h2 class="fs-30-36 fw-bold text-primary">{{__('As mais completas estatísticas de envio')}}</h2>
                <p class="col-lg-6 fs-18-20 fw-light text-1d1e1f mx-auto">{{__('A partir do nosso software é disponibilizado as mais completas estatísticas de envio, de modo a ter o controlo total sobre a eficiencia da sua campanha da marketing.')}}</p>
            </header>
            ...
            <ul class="nav nav-tabs d-none d-lg-flex justify-content-between border-0 gap-5 gap-xxl-0 mt-5"
                ...
                <li class="nav-item col-lg-3 col-xxl-auto" role="presentation">
                    ...
                    <button class="nav-link bg-transparent fs-18 fw-500 border-0 px-0 mx-auto mx-xxl-0 active"
                        ...
                        aria-controls="panel-1" aria-selected="true">{{__('Estatísticas globais')}}</button>
                ...
                <li class="nav-item col-lg-3 col-xxl-auto" role="presentation">
                    ...
                    <button class="nav-link bg-transparent fs-18 fw-500 border-0 px-0 mx-auto mx-xxl-0" id="panel-2-tab"
                        ...
                        aria-selected="false">{{__('Diagramas completos')}}</button>
                    <div class="rounded-pill tab-decoration-bar cursor-pointer" aria-hidden="true"></div>
                </li>
                <li class="nav-item col-lg-3 col-xxl-auto" role="presentation">
                    ...
                    <button class="nav-link bg-transparent fs-18 fw-500 border-0 px-0 mx-auto mx-xxl-0" id="panel-3-tab"
                        ...
                        aria-selected="false">{{__('Discriminação de custos')}}</button>
                    <div class="rounded-pill tab-decoration-bar cursor-pointer" aria-hidden="true"></div>
                </li>
                <li class="nav-item col-lg-3 col-xxl-auto" role="presentation">
                    ...
                    <button class="nav-link bg-transparent fs-18 fw-500 border-0 px-0 mx-auto mx-xxl-0" id="panel-4-tab"
                        ...
                        aria-selected="false">{{__('Estatísticas por país')}}</button>
                    <div class="rounded-pill tab-decoration-bar cursor-pointer" aria-hidden="true"></div>
                </li>
                <li class="nav-item col-lg-3 col-xxl-auto" role="presentation">
                    ...
                    <button class="nav-link bg-transparent fs-18 fw-500 border-0 px-0 mx-auto mx-xxl-0" id="panel-5-tab"
                        ...
                        aria-selected="false">{{__('Calendário de envios')}}</button>
                    <div class="rounded-pill tab-decoration-bar cursor-pointer" aria-hidden="true"></div>
                </li>
                <li class="nav-item col-lg-3 col-xxl-auto" role="presentation">
                    ...
                    <button class="nav-link bg-transparent fs-18 fw-500 border-0 px-0 mx-auto mx-xxl-0" id="panel-6-tab"
                        ...
                        aria-selected="false">{{__('Estado do envio')}}</button>
                    <div class="rounded-pill tab-decoration-bar cursor-pointer" aria-hidden="true"></div>
                </li>
            </ul>
            ...
            <div class="tab-content d-none d-lg-block mt-6" id="panels-tablist-content">
                <div class="tab-pane fade bg-edeef0 rounded-30 pt-4 pb-5 show active" id="panel-1" role="tabpanel"
                    ...
                    <div class="col-10 d-flex justify-content-between align-items-center py-5 mx-auto">
                        <div class="text-primary ps-lg-2">
                            <h4 class="fs-20-24 fw-500 mb-4">{{__('Estatísticas globais')}}</h4>
                ...
                <div class="tab-pane fade bg-edeef0 rounded-30 pt-4 pb-5" id="panel-2" role="tabpanel"
                    ...
                    <div class="col-10 d-flex justify-content-between align-items-center py-5 mx-auto">
                        <div class="text-primary ps-lg-2">
                            <h4 class="fs-20-24 fw-500 mb-4">{{__('Diagramas completos')}}</h4>
                            <p class="col-8 fw-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Saepe,
                                sed
                                optio
                                tenetur iusto, incidunt voluptate beatae itaque quo ex, voluptatum veniam porro. Omnis,
                ...
                <div class="tab-pane fade bg-edeef0 rounded-30 pt-4 pb-5" id="panel-3" role="tabpanel"
                    ...
                    <div class="col-10 d-flex justify-content-between align-items-center py-5 mx-auto">
                        <div class="text-primary ps-lg-2">
                            <h4 class="fs-20-24 fw-500 mb-4">{{__('Discriminação de custos')}}</h4>
                            <p class="col-8 fw-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Saepe,
                                sed
                                optio
                                tenetur iusto, incidunt voluptate beatae itaque quo ex, voluptatum veniam porro. Omnis,
                ...
                <div class="tab-pane fade bg-edeef0 rounded-30 pt-4 pb-5" id="panel-4" role="tabpanel"
                    ...
                    <div class="col-10 d-flex justify-content-between align-items-center py-5 mx-auto">
                        <div class="text-primary ps-lg-2">
                            <h4 class="fs-20-24 fw-500 mb-4">{{__('Estatísticas por país')}}</h4>
                            <p class="col-8 fw-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Saepe,
                                sed
                                optio
                                tenetur iusto, incidunt voluptate beatae itaque quo ex, voluptatum veniam porro. Omnis,
                ...
                <div class="tab-pane fade bg-edeef0 rounded-30 pt-4 pb-5" id="panel-5" role="tabpanel"
                    ...
                    <div class="col-10 d-flex justify-content-between align-items-center py-5 mx-auto">
                        <div class="text-primary ps-lg-2">
                            <h4 class="fs-20-24 fw-500 mb-4">{{__('Calendário de envios')}}</h4>
                            <p class="col-8 fw-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Saepe,
                                sed
                                optio
                                tenetur iusto, incidunt voluptate beatae itaque quo ex, voluptatum veniam porro. Omnis,
                ...
                <div class="tab-pane fade bg-edeef0 rounded-30 pt-4 pb-5" id="panel-6" role="tabpanel"
                    ...
                    <div class="col-10 d-flex justify-content-between align-items-center py-5 mx-auto">
                        <div class="text-primary ps-lg-2">
                            <h4 class="fs-20-24 fw-500 mb-4">{{__('Estado do envio')}}</h4>
                            <p class="col-8 fw-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Saepe,
                                sed
                                optio
                                tenetur iusto, incidunt voluptate beatae itaque quo ex, voluptatum veniam porro. Omnis,
            ...
            <div id="statistics-carousel" class="carousel slide carousel-fade carousel-dark d-lg-none"
                        ...
                        <div class="bg-edeef0 rounded-30 py-4 show active">
                            <div class="col-10 d-flex flex-column mx-auto">
                                <div class="text-primary text-center">
                                    ...
                                    <h4 class="fs-20-24 fw-500 mb-4 pt-1">{{__('Estatísticas globais')}}</h4>
                        ...
                        <div class="bg-edeef0 rounded-30 py-4">
                            <div class="col-10 d-flex flex-column mx-auto">
                                <div class="text-primary text-center">
                                    ...
                                    <h4 class="fs-20-24 fw-500 mb-4 pt-1">{{__('Diagramas completos')}}</h4>
                                    <p class="col-sm-9 fw-light mx-auto mb-0">Lorem ipsum dolor sit, amet consectetur
                                        adipisicing elit.
                                        Saepe,
                                        sed
                        ...
                        <div class="bg-edeef0 rounded-30 py-4">
                            <div class="col-10 d-flex flex-column mx-auto">
                                <div class="text-primary text-center">
                                    ...
                                    <h4 class="fs-20-24 fw-500 mb-4 pt-1">{{__('Discriminação de custos')}}</h4>
                                    <p class="col-sm-9 fw-light mx-auto mb-0">Lorem ipsum dolor sit, amet consectetur
                                        adipisicing elit.
                                        Saepe,
                                        sed
                        ...
                        <div class="bg-edeef0 rounded-30 py-4">
                            <div class="col-10 d-flex flex-column mx-auto">
                                <div class="text-primary text-center">
                                    ...
                                    <h4 class="fs-20-24 fw-500 mb-4 pt-1">{{__('Estatísticas por país')}}</h4>
                                    <p class="col-sm-9 fw-light mx-auto mb-0">Lorem ipsum dolor sit, amet consectetur
                                        adipisicing elit.
                                        Saepe,
                                        sed
                        ...
                        <div class="bg-edeef0 rounded-30 py-4">
                            <div class="col-10 d-flex flex-column mx-auto">
                                <div class="text-primary text-center">
                                    ...
                                    <h4 class="fs-20-24 fw-500 mb-4 pt-1">{{__('Calendário de envios')}}</h4>
                                    <p class="col-sm-9 fw-light mx-auto mb-0">Lorem ipsum dolor sit, amet consectetur
                                        adipisicing elit.
                                        Saepe,
                                        sed
                        ...
                        <div class="bg-edeef0 rounded-30 py-4">
                            <div class="col-10 d-flex flex-column mx-auto">
                                <div class="text-primary text-center">
                                    ...
                                    <h4 class="fs-20-24 fw-500 mb-4 pt-1">{{__('Estado do envio')}}</h4>
                                    <p class="col-sm-9 fw-light mx-auto mb-0">Lorem ipsum dolor sit, amet consectetur
                                        adipisicing elit.
                                        Saepe,
                                        sed
                ...
                <button class="carousel-control-next end-0" type="button" data-bs-target="#statistics-carousel"
                    ...
                    <span class="visually-hidden">{{__('Próximo')}}</span>
                </button>
            </div>
        </div>
            ...
            <div class="bg-white rounded-30 box-shadow-14-19 py-5">
                <div class="d-flex flex-column py-lg-5">
                    <header class="text-center fontspace-grotesk">
                        <h2 class="col-9 col-sm fw-bold fs-30-36 text 1415 mx-auto">{{__('Faça a gestão dos seus grupos')}}</h2>
                        <p
                            class="col-10 col-md-7 col-lg-6 col-xl-5 col-xxl-4 fw-light fs-18-20 text-1d1e1f mb-0 pb-1 mx-auto">{{__('Com a nossa ferramenta pode gerir os seus grupos de envio, criando uma segmentação de clientes.')}}</p>
    ...
    <section class="bg-primary pt-5 pt-lg-6 pb-6">
        <div class="container pb-5 pb-lg-6 pt-lg-2 mt-lg-4">
            <header class="text-center font-space-grotesk mb-5">
                <h2 class="text-white fw-bold fs-30-36 mb-3">{{__('API’s de conexão')}}</h2>
                <p class="col-md-8 col-lg-6 fs-18-20 fw-light fw-lg-500 text-d3d2 mb-0 mx-auto">{{__('A partir do nosso software é disponibilizado as mais completas estatísticas de envio, de modo a ter o controlo total sobre a eficiencia da sua campanha da marketing.')}}</p>
            </header>
            <ul
                ...
                <li
                    ...
                    {{__('Integração SMPP')}}</li>
                <li
                    class="bg-1d1e1f text-white text-center fs-15 font-archivo rounded-4 border border-color-1d1e1f ms-lg-3 px-5 py-2">
                    {{__('Integração HTTP GET')}}</li>
                <li
                    class="bg-1d1e1f text-white text-center fs-15 font-archivo rounded-4 border border-color-1d1e1f ms-lg-3 px-5 py-2">
                    {{__('Integração HTTP REST')}}</li>
            </ul>
