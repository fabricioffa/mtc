                ...
                <ul class="navbar-nav gap-4 fw-500 align-items-baseline font-space-grotesk">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-primary rounded-10" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item text-white hover-fw-500" href="{{ route('sms-marketing.em-massa') }}">{{__('SMS em Massa')}}</a>
                            </li>
                            <li><a class="dropdown-item text-white hover-fw-500" href="{{ route('sms-marketing.para-empresa') }}">{{__('SMS massivo para empresas')}}</a></li>
                            <li><a class="dropdown-item text-white hover-fw-500" href="{{ route('sms-marketing.rotas-sim') }}">{{__('SMS por Rotas SIM')}}</a></li>
                            <li><a class="dropdown-item text-white hover-fw-500" href="{{ route('sms-marketing.sem-restricoes') }}">{{__('SMS sem Restrições')}}</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link position-relative text-white font-archivo {{ request()->route()->named('precos') ? 'marked' : null }}" href="{{ route('precos') }}">{{__('Preços')}}</a>
                    </li>
