        ...
        <div class="container pt-4 pt-lg-5 mt-lg-5">
            <div class="d-flex flex-column flex-lg-row">
                <header class="font-space-grotesk text-center text-lg-start text-0e pb-4 pb-lg-0">
                    <h1 class="fs-36-50 fw-bold ls-1 mb-3">{{__('Envie SMS sem restrições')}}</h1>
                    <p class="col-lg-10 col-xl-11 col-xxl-10 fs-18-20 fw-500">{{__('Envie SMS através das nossas rotas sem restrições de conteúdo. Mytelecom.pt. do grupo Webhouse, assugura-lhe todos os canais de comunicação em massa.')}}</p>
                </header>
        ...
        <div class="container pt-5 pt-lg-0 pb-4 pb-lg-0 gx-3">
            ...
            <div class="bg-edeef0 rounded-12 rounded-lg-30 p-4 p-md-5">
                <div
                    ...
                    <p class="align-self-lg-start bg-ffee9c rounded-02 fw-500 text-ac8e00 px-3 py-2 mb-0">{{__('SMS Sem Restrições')}}
                    </p>
                </div>
                ...
                <div class="d-flex flex-wrap gap-2 gap-lg-custom-1 text-center pb-3 pb-lg-2 mb-1">
                    <div class="flex-grow-1 bg-white rounded-5 pt-4 pb-3 px-4">
                        <img class="mb-1" src="{{ asset('assets/imgs/icons/flags/canada.svg') }}"
                            alt="Bandeira do Canadá" class="d-block mx-auto">
            ...
            <div class="bg-edeef0 rounded-12 rounded-lg-30 p-4 p-md-5">
                <div
                    ...
                    <header
                        ...
                        <p class="fs-16-22 fw-500 ">{{__('Se possui o interesse em mercados internacionais, conte agora com a nossa rede de SMS Internacionais.')}}</p>
                    </header>
                    <p class="align-self-lg-start bg-ffee9c rounded-02 fw-500 text-ac8e00 px-3 py-2 mb-0">{{__('SMS Sem Restrições')}}</p>
                </div>
                ...
                <div
                    ...
                    <div class="flex-grow-1 d-flex align-items-center bg-white rounded-5 py-4 ps-4 pe-3">
                        <img src="{{ asset('assets/imgs/icons/flags/azerbaijan.svg') }}" alt="Bandeira do Azerbaijão">
