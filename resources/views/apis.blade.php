        ...
        <div class="container pb-5 mb-5">
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between font-space-grotesk pt-lg-5 mt-4 mt-xl-5">
                <div class="text-white text-center text-lg-start pt-lg-5">
                    <h1 class="fw-bold ls-1 fs-36-50 mb-4 mb-lg-3 mt-5 mt-xxl-0 mx-auto mx-lg-0">{{__('API’s de conexão')}}</h1>
        ...
        <div class="bg-edeef0 rounded-30 py-4 mb-5">
            <div
                ...
                <div class="text-start text-sm-center text-lg-start">
                    ...
                    <h3 class="fs-18-20 fw-500 text-1415 mb-4">{{__('Integração HTTP através de REST')}}</h3>
                    <p class="fw-light text-1415 pb-2 mb-5">{{__('A API de conexão HTTP permite integrar a sua aplicação com o nosso Gateway para o envio de SMS, utilizando o protocolo HTTP ou HTTPS ( para transações seguras através de criptografia SSL). Ambos os pedidos e as respostas são feitas API REST em formato JSON, tornando muito simples de usar API com qualquer linguagem de programação.')}}</p>
                    <a class="fs-18 fw-500 text-white bg-secondary rounded-4 text-decoration-none py-3 px-5" href=""
                        role="button">{{__('Ver documentação')}}</a>
                </div>
        ...
        <div class="bg-edeef0 rounded-30 py-4 mb-5">
            <div
                ...
                <div class="col-lg-5 text-start text-sm-center text-lg-start">
                    ...
                    <h3 class="fs-18-20 fw-500 text-1415 mb-4">{{__('Integração HTTP através de GET')}}</h3>
                    <p class="fw-light text-1415 pb-2 mb-5">{{__('A API de integração HTTP através de GET é a API de integração mais simples para o envio de SMS. Por norma, esta implementação é muito rápida e fácil, suportando uma ampla gama de tipos de mensagens e de funcionalidades. Devido ao seu tempo de integração, apenas é necessário um equipamento informático no qual possa executar o script ou a aplicação e um navegador ou um ferramenta http.')}}</p>
                    <a class="fs-18 fw-500 text-white bg-secondary rounded-4 text-decoration-none py-3 px-5" href=""
                        role="button">{{__('Ver documentação')}}</a>
                </div>
        ...
        <div class="bg-edeef0 rounded-30 py-4 mb-5">
            <div
                ...
                <div class="text-start text-sm-center text-lg-start">
                    ...
                    <h3 class="fs-18-20 fw-500 text-1415 mb-4">{{__('Integração através do protocolo padrão de SMS')}}</h3>
                    <p class="fw-light text-1415 pb-2 mb-5">
                        {{__('O protocolo Short Message Peer to Peer (SMPP) é o protocolo que considera padrão da indústria para envio de SMS para o padrão da indústria de mensagens rede do provedor projetado para simplificar a integração de aplicativos de dados com as redes móveis sem fio.')}}<br>
                        {{__('Além disso, trata-se do protocolo mais utilizado na indústria de telecomunicações para o intercâmbio de mensagens entre os SMSC (Short Message Service Centers) e ESME (External Short Messaging Entities). Este protocolo garante a entrega rápida de SMS, permitindo que vários pedidos de uma só vez.')}}
                    </p>
                    <a class="fs-18 fw-500 text-white bg-secondary rounded-4 text-decoration-none py-3 px-5" href=""
                        role="button">{{__('Ver documentação')}}</a>
                </div>
